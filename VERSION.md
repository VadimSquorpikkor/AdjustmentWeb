...
* <b>1.51 - 19/01/23</b>
1. Обновлена библиотека (новые employees и приборы) 
* <b>1.50 - 14/02/22</b>
1. Для альтернативного варианта "Отслеживания": добавлено отображение даты прихода на участок, названия локации. Если в локации нет событий, она не отображается
* <b>1.49 - 11/02/22</b>
1. Начал делать альтернативный вариант "Отслеживания"
* <b>1.48 - 11/02/22</b>
1. Исправлен список устройств (удалены лишние), к устройствам добавлены имена комплектов 
* <b>1.47 - 11/02/22</b>
